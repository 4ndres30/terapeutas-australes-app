...
`ui-050-encabezado-contextual`, integrada en `main` por PR #135. Reemplaza el texto estatico y
...
- UI-048/UI-049/UI-050/UI-051: propuestas de densidad y aprovechamiento de espacio en `PacientesPage` y el shell interno registradas durante revision local/demo. Las cuatro quedan integradas en `main`: UI-048 (PR #130), UI-049 (PR #134), UI-050 (PR #135) y UI-051 (PR #132).
