...
- QA-006/QA-006A/QA-006B/QA-006C/QA-006D: plan base de pruebas por rol, matriz de rutas/superficies, validacion visual sin sesion/autenticada local-demo, UI-023 post-merge y Reportes/Finanzas por rol documentadas.
...
- Ejecutar QA-006 por fases: con QA-006A documentada, QA-006B autenticada ejecutada local/demo, SEC-007B integrado, QA-006C validando post-merge UI-023 y QA-006D validando Reportes/Finanzas, continuar con Auth y RLS/Storage segun dependencias.
