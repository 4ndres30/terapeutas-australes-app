...
La implementacion futura depende de validar clinica/legalmente BE-020 y cerrar separacion de ambientes, auditoria sensible, seguridad de API, backup/restauracion y PROD-001.
