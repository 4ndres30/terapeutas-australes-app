...
- UI-020/UI-021: implementacion local del indicador visual de ambiente activo y bloqueo de produccion no habilitada, con QA-009 parcial; quedan pendientes mobile, `/agenda` especifico y bloqueo de produccion no habilitada.
...
- indicador visual de ambiente y bloqueo de produccion no habilitada implementados localmente por UI-020/UI-021, con QA-009 parcial y validaciones mobile/bloqueo aun pendientes;
