...
- UI-020/UI-021: implementacion local del indicador visual de ambiente activo y bloqueo de produccion no habilitada; UI-020 queda validada por QA-009 en `/agenda` local desktop/mobile equivalente y UI-021 queda pendiente de validacion visual del bloqueo.
...
- indicador visual de ambiente y bloqueo de produccion no habilitada implementados localmente por UI-020/UI-021, con UI-020 validada por QA-009 y bloqueo UI-021 aun pendiente;
