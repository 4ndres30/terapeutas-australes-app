...
- UI-020/UI-021: implementacion local del indicador visual de ambiente activo y bloqueo de produccion no habilitada, pendiente revision visual autenticada.
...
- indicador visual de ambiente y bloqueo de produccion no habilitada implementados localmente por UI-020/UI-021, pendientes de revision visual autenticada;
