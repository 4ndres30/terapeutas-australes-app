...
- UI-020/UI-021: diseno documental del indicador visual de ambiente activo y bloqueo de produccion no habilitada, pendiente implementacion futura.
...
- indicador visual de ambiente y bloqueo de produccion no habilitada documentados por UI-020/UI-021, pendientes de implementacion;
