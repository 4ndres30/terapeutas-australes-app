...
La integracion con Google Calendar y Gmail/Workspace debe pasar por backend controlado, con secretos fuera del frontend, eventos neutros, correos neutros, validacion, consentimiento, auditoria y revision interna previa.
